...
class ToDoStore {
    ...
    init() {
        ...
        if fileManager.fileExists(atPath: filePath) {
            ...
            items.append(Items(title:"Item Title", text: "Item Text", dueDate: "", category: 1))
            items.append(Items(title:"Item Title", text: "Item Text", dueDate: "", category: 2))
            items.append(Items(title:"Item Title", text: "Item Text", dueDate: "", category: 3))
    ...
    func getToDoItem(_ index: Int, category: Int) -> Items {
        return items[index]
    }
    func addToDo(_ item: Items, category: Int){
        items.insert(item, at:0 )
    ...
    func deleteToDoItem(_ index: Int) {
        items.remove(at: index)
    }
